...
interface TeamMember {
  ...
  const teamMembers: TeamMember[] = [
    ...
    { name: "Zarrar Hussain Abid", role: "Web Developer", bio: "Passionate about coding", github:"https://github.com/Zarrarabid", linkedin:"https://www.linkedin.com/in/zarrar-abid" },
  ...
  const Footer: React.FC = () => {
    ...
    return (
      <footer className="bg-[#81BFDA] bg-opacity-20 border-t-2 border-black border-opacity-5 shadow-lg backdrop-filter backdrop-blur-lg py-8 w-full">
      <div className="container mx-auto text-center">
        ...
        <ul className="flex justify-center gap-6">
          {teamMembers.map((member) => (
            <li
              key={member.name}
              className="cursor-pointer text-lg text-[#1f2937] hover:text-white"
